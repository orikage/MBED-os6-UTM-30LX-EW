...
int main(){
    ...
    while(1){
        ...
        int all_distance[361]={0};//配列サイズは1081/md_msg_grouping 繰り上げ
        ...
        if(response!=1141){printf("low response\n");response=socket.recv(rbuffer,sizeof(rbuffer));printf("%d\n",response);continue;}//grouping=3のとき
